...
public class Views extends JFrame {
    ...
    public Views() {
        ...
        JButton browseButton = new JButton("Exit");
    ...
    private void browseDirectory() {
        ...
        if (returnValue == 0) {
            ...
            this.populateTree(selectedDirectory, rootNode);
            this.fileTree.setModel(new DefaultTreeModel(rootNode));
        }
